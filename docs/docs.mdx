...
> - **New type exports** — `MaskVariant`, `MaskActivation`, and `MaskAnimation` types are now exported.
...
<Demo data={demos.maskSmoothingDemo} />
...
<Demo data={demos.maskTransition} />
...
<Demo data={demos.maskPositionChange} />

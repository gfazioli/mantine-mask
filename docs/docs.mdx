...
> **NOTE:**
>
> As you can see in this demo, when using `invertMask`, as well as the `bg` prop, you might want to set a background color on the `Mask` component itself to avoid transparency.
